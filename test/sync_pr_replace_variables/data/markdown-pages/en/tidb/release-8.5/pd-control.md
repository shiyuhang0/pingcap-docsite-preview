...
> **Note:**
>
> `{version}` in the link indicates the version number of TiDB. For example, the download link for `v8.5.3` in the `amd64` architecture is `https://download.pingcap.org/tidb-community-server-v8.5.3-linux-amd64.tar.gz`.
