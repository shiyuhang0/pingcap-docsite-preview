...
- Determines whether to clone a specific version of a package
    ...
    - Execute the `tiup mirror clone <target-dir> --tidb v8.5.3` command to clone the v8.5.3 version of the TiDB component.
    - Run the `tiup mirror clone <target-dir> --tidb v8.5.3 --tikv all` command to clone the v8.5.3 version of the TiDB component and all versions of the TiKV component.
    - Run the `tiup mirror clone <target-dir> v8.5.3` command to clone the v8.5.3 version of all components in a cluster.
